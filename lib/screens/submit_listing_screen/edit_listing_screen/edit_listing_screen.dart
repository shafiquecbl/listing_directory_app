...
import '../../../entities/listing.dart' as listing_entity;
...
import 'edit_listing_screen_model.dart';

class EditListingScreen extends StatefulWidget {
  final listing_entity.Listing listing;
  final Function onFinish;

  const EditListingScreen({Key key, this.listing, this.onFinish})
      : super(key: key);
  @override
...
class _EditListingScreenState extends State<EditListingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<EditListingScreenModel>(
      create: (_) => EditListingScreenModel(widget.listing),
      child: Consumer<EditListingScreenModel>(
        builder: (_, model, __) => Stack(
          children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (model.selectedPricePlan.listingprocSocial !=
                                'false') ...[
                              Consumer<EditListingScreenModel>(
                                builder: (_, m, __) => SocialMedias(
                                  socialMedias: m.socialMedias,
                                ),
                              ),
                              const SizedBox(height: 10.0),
                            ],
            ...
            if (model.state == EditListingState.loading)
              Container(
                width: size.width,
                height: size.height,
